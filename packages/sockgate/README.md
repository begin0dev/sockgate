...
[![npm version](https://img.shields.io/npm/v/@begin0dev/sockgate.svg)](https://www.npmjs.com/package/@begin0dev/sockgate)
...
| 옵션 | 타입 | 설명 |
|---|---|---|
| `sharedWorkerFactory` | `() => SharedWorker` | SharedWorker 생성 함수 (권장) |
| `sharedWorkerUrl` | `string` | 워커 스크립트 경로 (deprecated, `sharedWorkerFactory` 사용 권장) |
